...
@Component({
      ...
      <div class="container">
          ...
          <div class="footer__brand">
            <div class="footer__logo" aria-hidden="true">
              <svg width="20" height="22" viewBox="0 0 20 22" fill="none">
                ...
                <path d="M7 11l2 2 4-4" stroke="#3b82f6" stroke-width="1.5"
        ...
        <div class="footer__bottom">
          <p class="footer__copy">
            ...
            <strong>Amine Charrad</strong> — 2026
          </p>
          <div class="footer__social">
            <a href="https://github.com/amine77/devsecops-angular-java21-aws-25-05-2026"
               target="_blank" rel="noopener noreferrer"
               class="footer__social-link" aria-label="GitHub du projet">
  ...
  styles: [`
    ...
    .footer__social-link:hover { color: var(--color-text-primary); }
    @media (max-width: 768px) {
      .footer__grid { grid-template-columns: 1fr; gap: var(--spacing-xl); }
      .footer__bottom { flex-direction: column; gap: var(--spacing-sm); text-align: center; }
    }
  `],
})
